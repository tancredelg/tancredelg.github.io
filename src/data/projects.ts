...
export interface ProjectProps {
    ...
    technologies: string[];     // Technologies used in the project, e.g., ['javascript', 'react', 'tailwindcss', 'unreal-engine']
...
This project exposed me further to the industry-grade game development possible with Unreal Engine, and gaining broader experience with the engine - including its C++ API - leaves me equipped and excited to tackle bigger game dev amibitions in the future.`,
        ...
        media: [
            { type: 'image', src: 'src/data/projects/SS - multiple enemies fight.jpg', alt: 'Fighting multiple enemies in the game' },
            { type: 'image', src: 'src/data/projects/SS - jumping shot.jpg', alt: 'Shooting while jumping' },
            { type: 'image', src: 'src/data/projects/SS - lose screen.jpg', alt: 'Game over screen' },
            { type: 'image', src: 'src/data/projects/SS - behaviour tree.png', alt: 'Unreal Engine behavior tree for AI' },
            { type: 'image', src: 'src/data/projects/SS - anim state machines labelled.png', alt: 'Unreal Engine animation state machine' },
            { type: 'video', src: 'src/data/projects/SS - behaviour demo.mp4', alt: 'Demonstration of AI behavior' },
        ],
    },
    {
...
The app has a simple Flask backend that sends API requests for the speech-to-text conversion and then feedback generation, handles the inference of the vision model that tracks the user's eyes, and calculates some relevant metrics. The data is then sent back to the frontend on the summary page. The frontend is simple HTML & JavaScript (the latter mainly to record audio), and we opted for TailwindCSS for styling the UI, which helped in designing a UI.`,
        ...
        technologies: ['python', 'flask', 'javascript', 'openai-api', 'opencv', 'tailwindcss'],
        liveUrl: 'https://devpost.com/software/interview-practice-4w65a2',
        media: [
            { type: 'image', src: 'src/data/projects/HH - landing.png', alt: 'Landing page of the Help Help app' },
            { type: 'image', src: 'src/data/projects/HH - start recording.png', alt: 'Recording interface with animated eyes' },
            { type: 'image', src: 'src/data/projects/HH - stop recording.png', alt: 'Interface after stopping the recording' },
            { type: 'image', src: 'src/data/projects/HH - response summary.png', alt: 'Summary page with feedback and metrics' },
        ],
    },
    {
...
The SQLite backend is a simple database storing courses and course sections, which I built by scraping course data from the McGill course website using Python's beautifulsoup4 library.`,
        ...
        toDate: 'Dec 2024',
        categories: ['web-dev'],
        technologies: ['python', 'flask', 'sqlite', 'htmx', 'javascript'],
        liveUrl: 'https://mcgill-degree-planner.vercel.app',
        media: [
            { type: 'image', src: 'src/data/projects/MDP - term select.png', alt: 'Term selection interface' },
            { type: 'image', src: 'src/data/projects/MDP - course add.png', alt: 'Adding a course to the planner' },
            { type: 'image', src: 'src/data/projects/MDP - course remove.png', alt: 'Removing a course from the planner' },
            { type: 'image', src: 'src/data/projects/MDP - course set grade.png', alt: 'Setting a grade for a course' },
        ],
    },
    {
...
By demo time, we had a fully functional system that could handle plenty of clients and workers, and passing all the tests. I learned so much about distributed systems in this course and its assignments, ending really nicely with some case studies on the Google File System & Hadoop Distributed File System, the MapReduce programming model, and Spark. I'm glad I took this course, and recommend it to any McGill students looking for a COMP 500 course.`,
        fromDate: 'Nov 2024',
        categories: ['systems'],
        technologies: ['java', 'apache-zookeeper'],
        repoUrl: 'https://github.com/tancredelg/comp512-p3',
        media: [
            { type: 'image', src: 'src/data/projects/DCP - full view 1.png', alt: 'Full system view with manager, workers, and clients' },
            { type: 'image', src: 'src/data/projects/DCP - manager logs.png', alt: 'Log output from the manager server' },
            { type: 'image', src: 'src/data/projects/DCP - worker logs 1.png', alt: 'Log output from a worker server' },
            { type: 'image', src: 'src/data/projects/DCP - worker logs 2.png', alt: 'Log output from another worker server' },
        ],
    },
    {
        title: 'Cartographe',
...
The aim of the game is for users to create their own quizzes by selecting specific countries, cities, etc, and sharing the quiz with the public, allowing for a collaborative and educational experience. The game aims to make learning geography fun and engaging by combining accurate data with interactive gameplay.`,
        ...
        media: [
            { type: 'image', src: 'src/data/projects/Cartographe - France hovered (cities hidden).png', alt: 'Map showing France highlighted' },
            { type: 'image', src: 'src/data/projects/Cartographe - Singapore hovered (cities rank 0-3).png', alt: 'Map showing Singapore with city ranks' },
            { type: 'image', src: 'src/data/projects/Cartographe - Panama City hovered (all cities).png', alt: 'Map showing Panama City' },
            { type: 'image', src: 'src/data/projects/Cartographe - Greece mesh.png', alt: 'Generated 3D mesh for Greece' },
        ],
    },
    {
...
After finally achieving a working simulation, vectorizing the code via numpy made the whole thing run way faster, and the results were pretty satisfying.`,
        ...
        media: [
            { type: 'image', src: 'src/data/projects/EFS - screenshot.png', alt: 'Screenshot of the fluid simulation' },
            { type: 'video', src: 'src/data/projects/EFS - sink source compressed.mp4', alt: 'Video of the fluid simulation with a sink and source' },
        ],
    },
    {
        title: 'Mars Marine',
...
Learning UE5 has definitely been intense compared to Unity, but exploring such a powerful engine is definitely worth it, giving me a better sense of the game development landscape and the tools available to developers in the industry.`,
        ...
        media: [
            { type: 'image', src: 'src/data/projects/MM - health pack.png', alt: 'Player collecting a health pack' },
            { type: 'image', src: 'src/data/projects/MM - return to play area.png', alt: 'Warning message to return to the play area' },
...
The game also features a skill tree and leveling system, where players can spend points earned by clearing strongholds to unlock new abilities and improve their stats. It also has a local save system that allows players save and load games and have game settings persist between sessions, serializing the game state and settings to json files.`,
        ...
        media: [
            { type: 'image', src: 'src/data/projects/STS - mid game fighting enemies with sword.png', alt: 'Player fighting enemies with a sword' },
            { type: 'image', src: 'src/data/projects/STS - in game entering portal room.png', alt: 'Player entering a portal room' },
            { type: 'image', src: 'src/data/projects/STS - in game shooting arrow.png', alt: 'Player shooting an arrow' },
            { type: 'image', src: 'src/data/projects/STS - skill tree.png', alt: 'The in-game skill tree' },
            { type: 'image', src: 'src/data/projects/STS - death screen.png', alt: 'The game over screen' },
            { type: 'image', src: 'src/data/projects/STS - load save screen.png', alt: 'The load game screen' },
            { type: 'video', src: 'src/data/projects/STS - tests video compressed.mp4', alt: 'Gameplay video montage' },
        ],
    },
    {
...
Making this game taught me lots about grids and tilemaps, collision types and collision layers, animations and animation controllers/graphs, and some basic enemy behaviours.`,
        ...
        technologies: ['unity'],
        media: [
            { type: 'image', src: 'src/data/projects/DE - menu screen.png', alt: 'Main menu screen' },
            { type: 'image', src: 'src/data/projects/DE - jump shot.png', alt: 'Player shooting while jumping' },
            { type: 'image', src: 'src/data/projects/DE - rising water.png', alt: 'Water level rising in the dungeon' },
            { type: 'image', src: 'src/data/projects/DE - running in tunnel.png', alt: 'Player running through a tunnel' },
            { type: 'image', src: 'src/data/projects/DE - game over.png', alt: 'Game over screen' },
            { type: 'image', src: 'src/data/projects/DE - end screen.png', alt: 'Level completion screen' },
        ],
    },
    {
        title: 'Glitch Garden',
...
This was a great project for learning about all sorts of things in the Unity game engine during COVID-19 lockdowns, including cross-scene persistence, animations, and the Unity UI system.`,
        ...
        technologies: ['unity'],
        media: [
            { type: 'image', src: 'src/data/projects/GG - mid level.png', alt: 'Mid-game screenshot of a level' },
            { type: 'image', src: 'src/data/projects/GG - level complete.png', alt: 'Level complete screen' },
